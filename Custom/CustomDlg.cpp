...
void CCustomDlg::LoadIniValue()
{
	...
	keyKey[0][7]		= hge->Ini_GetInt(RESCONFIGS_KEYSETTING_1, RESCONFIGN_KEYCHARGE, RESCONFIGDEFAULT_KEYCHARGE_1);
	...
	keyKey[1][7]		= hge->Ini_GetInt(RESCONFIGS_KEYSETTING_2, RESCONFIGN_KEYCHARGE, RESCONFIGDEFAULT_KEYCHARGE_2);
	...
	joyKey[0][3]		= hge->Ini_GetInt(RESCONFIGS_KEYSETTING_1, RESCONFIGN_JOYCHARGE, RESCONFIGDEFAULT_JOYCHARGE);
	...
	joyKey[1][3]		= hge->Ini_GetInt(RESCONFIGS_KEYSETTING_2, RESCONFIGN_JOYCHARGE, RESCONFIGDEFAULT_JOYCHARGE);
...
void CCustomDlg::LoadDefaultValue()
{
	...
	keyKey[0][7]		= RESCONFIGDEFAULT_KEYCHARGE_1;	
	...
	keyKey[1][7]		= RESCONFIGDEFAULT_KEYCHARGE_2;	
	...
	joyKey[0][3]		= RESCONFIGDEFAULT_JOYCHARGE;
	...
	joyKey[1][3]		= RESCONFIGDEFAULT_JOYCHARGE;
...
bool CCustomDlg::saveFile()
{
	if (checkValid())
	{
		...
		hge->	Ini_SetInt(RESCONFIGS_KEYSETTING_1, RESCONFIGN_KEYCHARGE, keyKey[0][7]);
		...
		hge->	Ini_SetInt(RESCONFIGS_KEYSETTING_2, RESCONFIGN_KEYCHARGE, keyKey[1][7]);
		...
		hge->	Ini_SetInt(RESCONFIGS_KEYSETTING_1, RESCONFIGN_JOYCHARGE, joyKey[0][3]);
		...
		hge->	Ini_SetInt(RESCONFIGS_KEYSETTING_2, RESCONFIGN_JOYCHARGE, joyKey[1][3]);
