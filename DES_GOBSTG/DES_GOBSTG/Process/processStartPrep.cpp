...
//			part = data.getStage(scene) - 1;
	...
	BGLayer::ubg[UBGID_BGMASK].valueSetByName(SI_NULL, M_CLIENT_CENTER_X, M_CLIENT_CENTER_Y, M_CLIENT_WIDTH, M_CLIENT_HEIGHT, 0);
	BGLayer::ubg[UBGID_FGPAUSE].valueSetByName(SI_NULL, M_CLIENT_CENTER_X, M_CLIENT_CENTER_Y, M_CLIENT_WIDTH, M_CLIENT_HEIGHT, 0);
