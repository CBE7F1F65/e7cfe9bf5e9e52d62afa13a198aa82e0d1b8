...
rebuild:
		...
		hge->	Ini_SetInt(RESCONFIGS_KEYSETTING_1, RESCONFIGN_KEYCHARGE, RESCONFIGDEFAULT_KEYCHARGE_1);
		...
		hge->	Ini_SetInt(RESCONFIGS_KEYSETTING_1, RESCONFIGN_JOYCHARGE, RESCONFIGDEFAULT_JOYCHARGE);
		...
		hge->	Ini_SetInt(RESCONFIGS_KEYSETTING_2, RESCONFIGN_KEYCHARGE, RESCONFIGDEFAULT_KEYCHARGE_2);
		...
		hge->	Ini_SetInt(RESCONFIGS_KEYSETTING_2, RESCONFIGN_JOYCHARGE, RESCONFIGDEFAULT_JOYCHARGE);
	...
	KS_CHARGE_(0)		= hge->Ini_GetInt(RESCONFIGS_KEYSETTING_1, RESCONFIGN_KEYCHARGE, RESCONFIGDEFAULT_KEYCHARGE_1);	
	...
	KS_CHARGE_(1)		= hge->Ini_GetInt(RESCONFIGS_KEYSETTING_2, RESCONFIGN_KEYCHARGE, RESCONFIGDEFAULT_KEYCHARGE_2);	
	...
	JS_CHARGE_(0)	= hge->Ini_GetInt(RESCONFIGS_KEYSETTING_1, RESCONFIGN_JOYCHARGE, RESCONFIGDEFAULT_JOYCHARGE);
	...
	JS_CHARGE_(1)	= hge->Ini_GetInt(RESCONFIGS_KEYSETTING_2, RESCONFIGN_JOYCHARGE, RESCONFIGDEFAULT_JOYCHARGE);
