...
#define EVENTZONE_TYPEMASK_BULLET	(EVENTZONE_TYPE_BULLETFADEOUT|EVENTZONE_TYPE_SENDBULLET|EVENTZONE_TYPE_BULLETPERFECTFREEZE|EVENTZONE_TYPE_BULLETSTUPA|EVENTZONE_TYPE_BULLETEVENT)
