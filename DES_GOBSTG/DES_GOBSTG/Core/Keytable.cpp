...
*/
	...
	{"KS_UP",					(POINTER)&(GameInput::KS_UP)},
	{"KS_DOWN",					(POINTER)&(GameInput::KS_DOWN)},
	{"KS_LEFT",					(POINTER)&(GameInput::KS_LEFT)},
	{"KS_RIGHT",				(POINTER)&(GameInput::KS_RIGHT)},
	{"KS_FIRE",					(POINTER)&(GameInput::KS_FIRE)},
	{"KS_QUICK",				(POINTER)&(GameInput::KS_QUICK)},
	{"KS_SLOW",					(POINTER)&(GameInput::KS_SLOW)},
	{"KS_DRAIN",				(POINTER)&(GameInput::KS_DRAIN)},
	{"KS_PAUSE",				(POINTER)&(GameInput::KS_PAUSE)},
	{"KS_SKIP",					(POINTER)&(GameInput::KS_SKIP)},
	{"KS_ENTER",				(POINTER)&(GameInput::KS_ENTER)},
	{"KS_ESCAPE",				(POINTER)&(GameInput::KS_ESCAPE)},
	{"KS_CAPTURE",				(POINTER)&(GameInput::KS_CAPTURE)},

	{"KS_UP_0",					(POINTER)&(GameInput::KS_UP_(0))},
	{"KS_DOWN_0",				(POINTER)&(GameInput::KS_DOWN_(0))},
	{"KS_LEFT_0",				(POINTER)&(GameInput::KS_LEFT_(0))},
	{"KS_RIGHT_0",				(POINTER)&(GameInput::KS_RIGHT_(0))},
	{"KS_FIRE_0",				(POINTER)&(GameInput::KS_FIRE_(0))},
	{"KS_QUICK_0",				(POINTER)&(GameInput::KS_QUICK_(0))},
	{"KS_SLOW_0",				(POINTER)&(GameInput::KS_SLOW_(0))},
	{"KS_DRAIN_0",				(POINTER)&(GameInput::KS_DRAIN_(0))},
	{"KS_PAUSE_0",				(POINTER)&(GameInput::KS_PAUSE_(0))},
	{"KS_SKIP_0",				(POINTER)&(GameInput::KS_SKIP_(0))},
	{"KS_ENTER_0",				(POINTER)&(GameInput::KS_ENTER_(0))},
	{"KS_ESCAPE_0",				(POINTER)&(GameInput::KS_ESCAPE_(0))},
	{"KS_CAPTURE_0",			(POINTER)&(GameInput::KS_CAPTURE_(0))},

	{"KS_UP_1",					(POINTER)&(GameInput::KS_UP_(1))},
	{"KS_DOWN_1",				(POINTER)&(GameInput::KS_DOWN_(1))},
	{"KS_LEFT_1",				(POINTER)&(GameInput::KS_LEFT_(1))},
	{"KS_RIGHT_1",				(POINTER)&(GameInput::KS_RIGHT_(1))},
	{"KS_FIRE_1",				(POINTER)&(GameInput::KS_FIRE_(1))},
	{"KS_QUICK_1",				(POINTER)&(GameInput::KS_QUICK_(1))},
	{"KS_SLOW_1",				(POINTER)&(GameInput::KS_SLOW_(1))},
	{"KS_DRAIN_1",				(POINTER)&(GameInput::KS_DRAIN_(1))},
	{"KS_PAUSE_1",				(POINTER)&(GameInput::KS_PAUSE_(1))},
	{"KS_SKIP_1",				(POINTER)&(GameInput::KS_SKIP_(1))},
	{"KS_ENTER_1",				(POINTER)&(GameInput::KS_ENTER_(1))},
	{"KS_ESCAPE_1",				(POINTER)&(GameInput::KS_ESCAPE_(1))},
	{"KS_CAPTURE_1",			(POINTER)&(GameInput::KS_CAPTURE_(1))},
