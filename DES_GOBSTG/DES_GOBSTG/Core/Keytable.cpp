...
scrKeyWord scrKeyTable[] =
{
	...
	{"UBGID_LEFTIDBEGIN",		UBGID_LEFTIDBEGIN},
	{"UBGID_RIGHTIDBEGIN",		UBGID_RIGHTIDBEGIN},
	{"UFGID_LEFTIDBEGIN",		UFGID_LEFTIDBEGIN},
	{"UFGID_RIGHTIDBEGIN",		UFGID_RIGHTIDBEGIN},
	{"UBGID_BGMASK",			UBGID_BGMASK},
	{"UFGID_FGPAUSE",			UBGID_FGPAUSE},
	...
	{"STOPFLAG_PLAYER_0",		FRAME_STOPFLAG_PLAYER_0},
	{"STOPFLAG_PLAYER_1",		FRAME_STOPFLAG_PLAYER_1},
	...
	{"EFFSPCHASE_SENDREDBULLET_0",		EFFSPSET_SYSTEM_SENDREDBULLET_0},
	{"EFFSPCHASE_SENDBLUEBULLET_0",		EFFSPSET_SYSTEM_SENDBLUEBULLET_0},
	{"EFFSPCHASE_SENDREDBULLET_1",		EFFSPSET_SYSTEM_SENDREDBULLET_1},
	{"EFFSPCHASE_SENDBLUEBULLET_1",		EFFSPSET_SYSTEM_SENDBLUEBULLET_1},
	{"EFFSPCHASE_SENDREDBULLET_2",		EFFSPSET_SYSTEM_SENDREDBULLET_2},
	{"EFFSPCHASE_SENDBLUEBULLET_2",		EFFSPSET_SYSTEM_SENDBLUEBULLET_2},
	...
	{"EFFSPCHASE_SENDGREENGHOST",		EFFSPSET_SYSTEM_SENDGREENGHOST},
	{"EFFSPCHASE_SENDYELLOWGHOST",		EFFSPSET_SYSTEM_SENDYELLOWGHOST},
	{"EFFSPCHASE_SENDREDGHOST",			EFFSPSET_SYSTEM_SENDREDGHOST},
	...
	{"KS_CHARGE",				(DWORD)&(KS_CHARGE_MP)},
	{"KS_PAUSE",				(DWORD)&(KS_PAUSE_MP)},
	{"KS_SKIP",					(DWORD)&(KS_SKIP_MP)},
	{"KS_ENTER",				(DWORD)&(KS_ENTER_MP)},
	{"KS_ESCAPE",				(DWORD)&(KS_ESCAPE_MP)},
	{"KS_CAPTURE",				(DWORD)&(KS_CAPTURE_MP)},

	{"KS_UP_0",					(DWORD)&(KS_UP_MP_(0))},
	{"KS_DOWN_0",				(DWORD)&(KS_DOWN_MP_(0))},
	{"KS_LEFT_0",				(DWORD)&(KS_LEFT_MP_(0))},
	{"KS_RIGHT_0",				(DWORD)&(KS_RIGHT_MP_(0))},
	{"KS_FIRE_0",				(DWORD)&(KS_FIRE_MP_(0))},
	{"KS_QUICK_0",				(DWORD)&(KS_QUICK_MP_(0))},
	{"KS_SLOW_0",				(DWORD)&(KS_SLOW_MP_(0))},
	{"KS_CHARGE_0",				(DWORD)&(KS_CHARGE_MP_(0))},
	{"KS_PAUSE_0",				(DWORD)&(KS_PAUSE_MP_(0))},
	{"KS_SKIP_0",				(DWORD)&(KS_SKIP_MP_(0))},
	{"KS_ENTER_0",				(DWORD)&(KS_ENTER_MP_(0))},
	{"KS_ESCAPE_0",				(DWORD)&(KS_ESCAPE_MP_(0))},
	{"KS_CAPTURE_0",			(DWORD)&(KS_CAPTURE_MP_(0))},

	{"KS_UP_1",					(DWORD)&(KS_UP_MP_(1))},
	{"KS_DOWN_1",				(DWORD)&(KS_DOWN_MP_(1))},
	{"KS_LEFT_1",				(DWORD)&(KS_LEFT_MP_(1))},
	{"KS_RIGHT_1",				(DWORD)&(KS_RIGHT_MP_(1))},
	{"KS_FIRE_1",				(DWORD)&(KS_FIRE_MP_(1))},
	{"KS_QUICK_1",				(DWORD)&(KS_QUICK_MP_(1))},
	{"KS_SLOW_1",				(DWORD)&(KS_SLOW_MP_(1))},
	{"KS_CHARGE_1",				(DWORD)&(KS_CHARGE_MP_(1))},
	{"KS_PAUSE_1",				(DWORD)&(KS_PAUSE_MP_(1))},
	{"KS_SKIP_1",				(DWORD)&(KS_SKIP_MP_(1))},
	{"KS_ENTER_1",				(DWORD)&(KS_ENTER_MP_(1))},
	{"KS_ESCAPE_1",				(DWORD)&(KS_ESCAPE_MP_(1))},
	{"KS_CAPTURE_1",			(DWORD)&(KS_CAPTURE_MP_(1))},
